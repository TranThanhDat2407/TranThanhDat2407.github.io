...
<body>
 ...
 <%@include file="/views/ClientTemplate/layout/nav.jsp"%>
	<fmt:setBundle basename="new_address" scope="request"/>
	<!-- content -->
  ...
  <div class="container">
        ...
        margin-bottom: 50px;">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#" style="color:green; text-decoration: none;"><fmt:message key="na.breadcrumHome"/></a></li>
                <li class="breadcrumb-item"><a href="#" style="color:green; text-decoration: none;"><fmt:message key="na.breadcrumProfile"/></a></li>
            </ol>
        </nav>
                ...
                style="   margin-left: -12px;width:249px;height: 300px;">
                    ...
                    <li class="nav-item" style="border-top: 3px solid #f0f0f0;width: 248px;">
                     <a href="<%=request.getContextPath()%>/client/profile">  <button class="decor_btn_menu "
                        ...
                        <fmt:message key="na.menu1"/></button></a> 
                    </li>
                <li class="nav-item"  >
                <a href="<%=request.getContextPath()%>/client/profile/order"> 
                    <button class=" decor_btn_menu " id="home-tab" 
                        ...
                        ><i class="fa-solid fa-clock-rotate-left"
                            style="font-size: 20px; margin-right: 10px;"></i><fmt:message key="na.menu2"/></button>
                            </a>
                </li>
                <li class="nav-item" >
                <a href="<%=request.getContextPath()%>/client/profile/address"> 
                    <button class="decor_btn_menu active "
                        type="button"><i
                            ...
                            style="font-size: 20px;margin-left: -5px; margin-right: 10px;"></i><fmt:message key="na.menu3"/></button>
                            </a>
                </li>
                <li class="nav-item" >
                 <a href="<%=request.getContextPath()%>/client/profile/change_password">
                    <button class="decor_btn_menu" 
                        ...
                        <fmt:message key="na.menu4"/></button>
                        </a>
                </li>
            </ul>
        </div>
                ...
                <div class="tab-pane fade show active"  
                    ...
                    <div class="row">
                        <div class="col-12 tab_Mini1">
                          <strong><fmt:message key="na.title"/></strong>
                        </div>
                        <div class="col-12 tab_Mini2">
                          <form class="edit_address" method="post" style="padding: 20px 40px">
                            <div class="mb-3">
                              <label for="province" class="form-label"><fmt:message key="na.city"/></label>
                            ...
                            <div class="mb-3">
                              <label for="district" class="form-label"><fmt:message key="na.ward"/></label>
                           <%--    <select class="form-control" id="district">
                            ...
                            <div class="mb-3">
                              <label for="ward" class="form-label"><fmt:message key="na.street"/></label>
