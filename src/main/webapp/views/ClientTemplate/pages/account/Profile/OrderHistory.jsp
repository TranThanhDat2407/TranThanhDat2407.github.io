...
<body>
 ...
 <%@include file="/views/ClientTemplate/layout/nav.jsp"%>
	<fmt:setBundle basename="order_history" scope="request"/>
	<div class="container">
    <nav aria-label="breadcrumb" style="margin-left:80px; margin-top: 15px;
    margin-bottom: 50px;">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#" style="color:green; text-decoration: none;"><fmt:message key="oh.breadcrumHome"/></a></li>
            <li class="breadcrumb-item"><a href="#" style="color:green; text-decoration: none;"><fmt:message key="oh.breadcrumProfile"/></a></li>
        </ol>
    </nav>
</div>
    ...
    <div class="col-3" style=" width: 250px;margin-top: 200px; height: 287px;margin-left: 4px;
        ...
        <ul class="nav flex-column nav-pills set_btnMenu" id="myTab" role="tablist"
            ...
            <!-- <li class="nav-item" role="presentation" ">
                ...
                <li class="nav-item" role="presentation" style="border-top: 3px solid #f0f0f0;width: 248px;">
                <a href="<%=request.getContextPath()%>/client/profile"> 
                    <button class="decor_btn_menu " 
                        ...
                        <fmt:message key="oh.menu1"/></button>
                        </a>
                </li>
            <li class="nav-item" role="presentation"  >
                <button class=" decor_btn_menu active"><i class="fa-solid fa-clock-rotate-left"
                        style="font-size: 20px; margin-right: 10px;"></i> <fmt:message key="oh.menu2"/></button>
            </li>
            <li class="nav-item" role="presentation">
            <a href="<%=request.getContextPath()%>/client/profile/address"> 
                <button class="decor_btn_menu " 
                    type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false"><i
                        ...
                        style="font-size: 20px;margin-left: -5px; margin-right: 10px;"></i> <fmt:message key="oh.menu3"/></button>
                        </a>
            </li>
            <li class="nav-item" role="presentation">
         <a href="<%=request.getContextPath()%>/client/profile/change_password"> 
                <button class="decor_btn_menu" 
                 ...
                 <fmt:message key="oh.menu4"/> </button>
                    </a>
            </li>
            ...
            <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                ...
                <div class="row">
                    <div class="col-12 tab_Mini1">
                        <strong><fmt:message key="oh.title"/> </strong>
                    </div>
                    <div class="col-12 tab_Mini2" style="height:500px;">
                        <table class="table " style="margin-top: 20px;">
                            <thead>
                                <tr
                                    style="width: 200px; height: 80px;justify-content: center;font-size: 13px; font-weight: bold; ">
                                      <th scope="col" style="width: 500px;"><label for=""
                                            style="justify-content: center;margin-bottom: 20px;"><fmt:message key="oh.no"/></label></th>
                                    <th scope="col" style="width: 500px;"><label for=""
                                            style="justify-content: center;margin-bottom: 20px;"><fmt:message key="oh.orderID"/></label></th>
                                    <th scope="col" style="width: 400px;"><label for=""
                                            style="justify-content: center;margin-bottom: 20px;"><fmt:message key="oh.total"/></label></th>
                                    <th scope="col" style="width: 500px;"><label for=""
                                            style="justify-content: center;margin-bottom: 20px;"><fmt:message key="oh.date"/></label>
                                    </th>
                                    <th scope="col" style="width: 200px;"><label for=""
                                            style="justify-content: center;margin-bottom: 20px;"><fmt:message key="oh.detail"/></label></th>
                                </tr>
                            </thead>
                            <tbody>
                            ...
                            <c:forEach items="${listOrder}" var="item">
                                <tr style="width: 200px; height: 90px; font-size: 13px; font-weight: bold;">
                                   <th><label for="" style="margin-top: 30px;">${index}</label></th>
                                    <th><label for="" style="margin-top: 30px;">${item.id}</label></th>
                                    <td><label for="" style="margin-top: 30px;"><fmt:formatNumber type = "number" 
         										pattern="#,###"   value = "${item.totalAmount}" /> VNĐ</label></td>
                                    <td><label for="" style="margin-top: 30px;margin-left: 10px;">
                                    <fmt:formatDate value="${item.createAt}" pattern="dd/MM/yyyy"/></label>
                                    </td>
                                    
                                    <td>
                                    <label style="margin-top: 20px;">	
                                    <a href="<%=request.getContextPath()%>/client/profile/order/detail?id=${item.id}"><button
										class="btn btn-outline-success " style="width: 170px;"><fmt:message key="oh.detail"/></button>
									</a>
									</label>
									</td>
