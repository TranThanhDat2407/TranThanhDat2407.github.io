...
<div class="container">
    ...
    margin-bottom: 50px;">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#" style="color:green; text-decoration: none;"> <fmt:message key="profile.breadcrumHome"/></a></li>
            <li class="breadcrumb-item"><a href="#" style="color:green; text-decoration: none;"> <fmt:message key="profile.breadcrumProfile"/></a></li>
        </ol>
    </nav>
...
<div class="row" style="width: 1200px; ;margin-top: -200px; height: 600px;">
    ...
    <div class="col-3" style=" width: 250px;margin-top: 200px; height: 287px;margin-left: 4px;
        ...
        <ul class="nav flex-column nav-pills set_btnMenu" style="margin-left: -12px;width:249px;height: 300px;">
            ...
            <a href="<%=request.getContextPath()%>/client/profile/order">
                <button class=" decor_btn_menu "
                  type="button"
                    aria-selected="true"><i class="fa-solid fa-clock-rotate-left"
                        style="font-size: 20px; margin-right: 10px;"></i> <fmt:message key="profile.menu2"/></button>
                        </a>
            </li>
            <li class="nav-item " >
                <a href="<%=request.getContextPath()%>/client/profile/address">
                    ...
                    type="button"><i
                        ...
                        style="font-size: 20px;margin-left: -5px; margin-right: 10px;"></i><fmt:message key="profile.menu3"/></button>
                </a>
            ...
            <li class="nav-item" >
                ...
                <button class="decor_btn_menu"
                    ...
                    <fmt:message key="profile.menu4"/> </button>
                    </a>
            </li>
        </ul>
    </div>
                ...
                <form action="">
                    <div class="detail_infor">
                        <table class="table .table-borderless ">
                            <tbody>
                              <tr>
                                <td class="lable"> <fmt:message key="profile.name"/></td>
                                <td class="text">${user.name}</td>
                           
                              </tr>
                              <tr>
                          
                                <td class="lable"> <fmt:message key="profile.phone"/></td>
                                <td  class="text">${user.phone}</td>
                             
                              </tr>
                              <tr>
                                <td class="lable"> <fmt:message key="profile.address"/></td>
                                <c:if test="${not empty AddressDefault}">
                                <td  class="text">${AddressDefault[0][1]}, ${AddressDefault[0][2]}, ${AddressDefault[0][3]}</td>
                                 </c:if>
                                <td ></td> 
                              </tr>
                            </tbody>
...
<a href="<%=request.getContextPath()%>/client/profile/edit">
    <button
    type="button"
